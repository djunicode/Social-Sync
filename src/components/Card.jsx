    ...
    <div className="m-2">
      <div className="bg-gray-800 rounded-lg ">
        ...
        <div className="flex items-center ml-3 mb-2">
          ...
          />
          <p className="text-white text-sm">{username || "@user123"}</p>
        </div>
