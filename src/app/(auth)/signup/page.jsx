...
export default function Page() {
  return (
    <main className=' min-h-screen flex flex-col bg-dark justify-center items-center md:py-24 py-12 px-6'>
      <div className=' w-fit flex flex-col gap-6 justify-center items-center'>
        ...
        <section className=' flex w-[80vw] lg:max-w-[35vw] md:max-w-[60vw] flex-col justify-start items-center md:p-12 p-6 bg-[#1d1d2f] rounded-3xl border-2 border-slate-50'>
          <h2 className=' md:text-4xl text-2xl font-semibold text-center'>Sign up for an account</h2>
          <Form/>
        </section>
        <section className=' flex flex-row text-lg gap-1'>
          <h3>Already have an account?</h3>
          <Link href={'/login'} className=' text-primary underline decoration-primary'>Log in</Link>
          <h3>here</h3>
        </section>
      </div>
    </main>
