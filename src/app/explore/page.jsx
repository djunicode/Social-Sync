                    ...
                    <Card className="h-screen fixed bg-[#1C1D2F] w-full max-w-[18rem] p-4 pt-6 shadow-xl shadow-blue-gray-900/5">
                        ...
                        <div class="flex items-center ml-3 mb-5 mt-5 ">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-gray-400">@usergaming</p>
                            </div>
                        </div>
                        {/* <div className="p-2">
        <Input
                ...
                <div className="flex flex-col pt-12 items-center h-full w-full ml-[18rem] bg-[#030421]">
                    ...
                    <div className="grid grid-cols-3 gap-10">
                        <div className="bg-gray-800 rounded-lg ">
                            ...
                            <div className="flex">
                                <p className="text-gray-400 pr-8 text-left ml-3 mb-3 text-sm">00,000 views</p>
                                <p className="text-gray-400 pl-20 ml-3 mb-3 text-sm">dd/mm/yyyy</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-10 mb-10">
                        <div className="bg-gray-800 rounded-lg ">
                            ...
                            <div className="flex">
                                <p className="text-gray-400 pr-8 text-left ml-3 mb-3 text-sm">00,000 views</p>
                                <p className="text-gray-400 pl-20 ml-20 mb-3 text-sm">Live</p>
                            </div>
                        </div>
                    ...
                    <div className=" flex space-x- items-centre mb-6 ">
                        <div className="w-35 h-100 mx-4">
                        <div class="bg-white rounded-full p-4 shadow-lg">
                            <img
                                src="full-name.png"
                                alt="Full Name"
                        ...
                        <h1 className="mt-1">Creator Name</h1>
